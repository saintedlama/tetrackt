	...
	return []SynthPatch{
		...
		{Name: "SID Sawtooth", Category: "Lead", Tags: []string{"C64"},
			Synth: &audio.Synth{
				...
				Filter:      audio.Filter{Type: audio.FilterLowPass, Cutoff: 0.65, Resonance: 0.3},
			}},
		{Name: "SID Pulse Lead", Category: "Lead", Tags: []string{"C64"},
			Synth: &audio.Synth{
				...
				Mixer:       audio.Mixer{Volume1: 1.0, Mode: audio.MixSoftClip},
				Filter:      audio.Filter{Type: audio.FilterLowPass, Cutoff: 0.7, Resonance: 0.35},
			}},
		{Name: "SID Hard Lead", Category: "Lead", Tags: []string{"C64"},
			Synth: &audio.Synth{
				...
				Mixer:       audio.Mixer{Volume1: 1.0, Mode: audio.MixSoftClip},
				Filter:      audio.Filter{Type: audio.FilterLowPass, Cutoff: 0.5, Resonance: 0.6},
			}},
	...
	return []SynthPatch{
		...
		{Name: "SID Acid Bass", Category: "Bass", Tags: []string{"C64"},
			Synth: &audio.Synth{
				...
				Mixer:       audio.Mixer{Volume1: 1.0, Mode: audio.MixSoftClip},
				Filter:      audio.Filter{Type: audio.FilterLowPass, Cutoff: 0.55, Resonance: 0.7},
			}},
		...
		{Name: "Moog Bass", Category: "Bass", Tags: []string{"Analog"},
			Synth: &audio.Synth{
				...
				Mixer:       audio.Mixer{Volume1: 1.0},
				Filter:      audio.Filter{Type: audio.FilterLowPass, Cutoff: 0.5, Resonance: 0.5},
				Portamento:  0.05,
			}},
		{Name: "Acid Techno", Category: "Bass", Tags: []string{"Analog"},
			Synth: &audio.Synth{
				...
				Mixer:       audio.Mixer{Volume1: 1.0},
				Filter:      audio.Filter{Type: audio.FilterLowPass, Cutoff: 0.6, Resonance: 0.75},
				LFO1:        audio.LFO{Waveform: audio.LFOSine, Rate: 2.0, Depth: 0.3, Dest: audio.ModCutoff},
			}},
	}
}
	...
	return []SynthPatch{
		...
		{Name: "String Ensemble", Category: "Pad", Tags: []string{"Analog"},
			Synth: &audio.Synth{
				...
				Filter:      audio.Filter{Type: audio.FilterLowPass, Cutoff: 0.75, Resonance: 0.1},
			}},
		{Name: "Warm Synth Pad", Category: "Pad", Tags: []string{"Analog"},
			Synth: &audio.Synth{
				...
				Mixer:       audio.Mixer{Volume1: 1.0},
				Filter:      audio.Filter{Type: audio.FilterLowPass, Cutoff: 0.65, Resonance: 0.05},
		...
		{Name: "Shimmer Pad", Category: "Pad", Tags: []string{"Analog"},
			Synth: &audio.Synth{
				...
				Mixer:       audio.Mixer{Volume1: 0.6, Volume2: 0.6},
				Filter:      audio.Filter{Type: audio.FilterLowPass, Cutoff: 0.7, Resonance: 0.15},
		...
		{Name: "Dream Pad", Category: "Pad",
			Synth: &audio.Synth{
				...
				Filter:      audio.Filter{Type: audio.FilterLowPass, Cutoff: 0.7, Resonance: 0.05},
			}},
	}
}
...
func percussivePatches() []SynthPatch {
	...
	return []SynthPatch{
		...
		{Name: "808 Kick", Category: "Percussive", Tags: []string{"Analog"},
			Synth: &audio.Synth{
				Oscillator1: audio.Oscillator{Type: audio.Sine},
	...
	return []SynthPatch{
		...
		{Name: "Explosion", Category: "SFX", Tags: []string{"NES"},
			Synth: &audio.Synth{
				...
				Mixer:       audio.Mixer{Volume1: 1.0, Mode: audio.MixNESPulse},
				Filter:      audio.Filter{Type: audio.FilterLowPass, Cutoff: 0.45, Resonance: 0.1},
			}},
		{Name: "SID Laser", Category: "SFX", Tags: []string{"C64"},
			Synth: &audio.Synth{
				...
				Mixer:       audio.Mixer{Volume1: 1.0, Mode: audio.MixSoftClip},
				Filter:      audio.Filter{Type: audio.FilterLowPass, Cutoff: 0.7, Resonance: 0.3},
