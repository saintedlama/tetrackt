	...
	return []ui.HelpSection{
		{
			...
			Entries: []ui.HelpEntry{
				...
				{Key: "", Desc: ""},
				{Key: "0-9 / A-F", Desc: "Hex entry for VOL column (2 digits → V00–VFF)"},
				{Key: "V/P/S/C/D/A + hex", Desc: "FX column: vibrato, portamento, vol-slide, cut, delay, arp"},
				{Key: "  e.g. V84", Desc: "Vibrato speed=8 depth=1.0; P08 glide 8 ticks"},
				{Key: "  e.g. A14", Desc: "Arp preset 1 (up) step 4; A00 clears arp"},
				...
				{Key: "Alt+D", Desc: "Duplicate row to row+step, advance cursor"},
				{Key: "", Desc: ""},
